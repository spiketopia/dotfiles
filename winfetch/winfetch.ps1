...
$img = if (-not $noimage) {
    if ($image) {
        ...
        } elseif ($logo -eq "Hello") {
            $COLUMNS = 35
            @(
                "${e}[${t};31m  _   _${e}[${t};33m _____${e}[${t};34m _    ${e}[${t};36m _   ${e}[${t};32m  ___ ${e}[${t};35m _"
                "${e}[${t};31m | | | ${e}[${t};33m| ____${e}[${t};34m| |   ${e}[${t};36m| |  ${e}[${t};32m / _ \${e}[${t};35m| |" 
                "${e}[${t};31m | |_| ${e}[${t};33m|  _| ${e}[${t};34m| |   ${e}[${t};36m| |  ${e}[${t};32m| | | ${e}[${t};35m| |" 
                "${e}[${t};31m |  _  ${e}[${t};33m| |___${e}[${t};34m| |___${e}[${t};36m| |__${e}[${t};32m| |_| ${e}[${t};35m|_|"
                "${e}[${t};31m |_| |_${e}[${t};33m|_____${e}[${t};34m|_____${e}[${t};36m|____${e}[${t};32m_\___/${e}[${t};35m(_)"
                "${e}[${t};39m⠇ ⣇⣿⠘⣿⣿⣿⡿⡿⣟⣟⢟⢟⢝⠵⡝⣿⡿⢂⣼⣿⣷⣌⠩⡫⡻⣝⠹⢿⣿⣷ ⠸"   
                "${e}[${t};39m⠇ ⡆⣿⣆⠱⣝⡵⣝⢅⠙⣿⢕⢕⢕⢕⢝⣥⢒⠅⣿⣿⣿⡿⣳⣌⠪⡪⣡⢑⢝⣇ ⠸"
                "${e}[${t};39m⠇ ⡆⣿⣿⣦⠹⣳⣳⣕⢅⠈⢗⢕⢕⢕⢕⢕⢈⢆⠟⠋⠉⠁⠉⠉⠁⠈⠼⢐⢕⢽ ⠸"
                "${e}[${t};39m⠇ ⡗⢰⣶⣶⣦⣝⢝⢕⢕⠅⡆⢕⢕⢕⢕⢕⣴⠏⣠⡶⠛⡉⡉⡛⢶⣦⡀⠐⣕⢕ ⠸"
